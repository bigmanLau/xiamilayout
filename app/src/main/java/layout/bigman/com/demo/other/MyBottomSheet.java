...
public class MyBottomSheet extends Dialog {
    ...
    public static class BottomListSheetBuilder {
        ...
        public MyBottomSheet.BottomListSheetBuilder setIsShowButton(boolean isShowButton) {
            mIsShowButton = isShowButton;
            return this;
        }

        public MyBottomSheet.BottomListSheetBuilder setButtonText(CharSequence buttonText) {
            mButtonText = buttonText;
            return this;
        }

        public MyBottomSheet.BottomListSheetBuilder setButtonClickListener(View.OnClickListener buttonClickListener) {
         ...
         * @param textAndTag Item 的文字内容，同时会把内容设置为 tag。
         */
        public BottomListSheetBuilder addItem(String textAndTag,Object data) {
            mItems.add(new BottomSheetListItemData(textAndTag, textAndTag,data));
            return this;
        }
         ...
         * @param text     Item 的文字内容。
         * @param tag      Item 的 tag。
         * @param isCenter Item 是否居中显示
         */
        public BottomListSheetBuilder addItem(int imageRes, String text, String tag,boolean isCenter) {
            Drawable drawable = imageRes != 0 ? ContextCompat.getDrawable(mContext, imageRes) : null;
            mItems.add(new BottomSheetListItemData(drawable, text, tag,isCenter));
            return this;
        }

        /**
         * @param imageRes Item 的图标 Resource。
         * @param textAndTag     Item 的文字内容。
         * @param textAndTag      Item 的 tag。
         * @param isCenter        Item 是否居中显示
         */
        public BottomListSheetBuilder addItem(int imageRes, String textAndTag,boolean isCenter) {
            Drawable drawable = imageRes != 0 ? ContextCompat.getDrawable(mContext, imageRes) : null;
            mItems.add(new BottomSheetListItemData(drawable, textAndTag, textAndTag,isCenter));
            return this;
        }
         ...
         */
        public BottomListSheetBuilder addItem(int imageRes, String text, String tag, boolean hasRedPoint,boolean isCenter) {
            Drawable drawable = imageRes != 0 ? ContextCompat.getDrawable(mContext, imageRes) : null;
            mItems.add(new BottomSheetListItemData(drawable, text, tag, hasRedPoint,isCenter));
            return this;
        }
         ...
         */
        public BottomListSheetBuilder addItem(int imageRes, String text, String tag, boolean hasRedPoint,boolean isCenter, boolean disabled) {
            Drawable drawable = imageRes != 0 ? ContextCompat.getDrawable(mContext, imageRes) : null;
            mItems.add(new BottomSheetListItemData(drawable, text, tag, hasRedPoint,isCenter, disabled));
            return this;
        }
        ...
        public MyBottomSheet build() {
            mDialog = new MyBottomSheet(mContext);
        ...
        private View buildViews() {
            ...
            mTitleTv = (TextView) wrapperView.findViewById(com.qmuiteam.qmui.R.id.title);
            mContainerView = (ListView) wrapperView.findViewById(com.qmuiteam.qmui.R.id.listview);
            mBottomButton = (TextView) wrapperView.findViewById(com.qmuiteam.qmui.R.id.bottom_sheet_close_button);
        ...
        private boolean needToScroll() {
            int itemHeight = QMUIResHelper.getAttrDimen(mContext, com.qmuiteam.qmui.R.attr.qmui_bottom_sheet_list_item_height);
            ...
            if (mTitleTv != null && !QMUILangHelper.isNullOrEmpty(mTitle)) {
                totalHeight += QMUIResHelper.getAttrDimen(mContext, com.qmuiteam.qmui.R.attr.qmui_bottom_sheet_title_height);
            }
        ...
        protected int getListMaxHeight() {
            return (int) (QMUIDisplayHelper.getScreenHeight(mContext) * 0.7);
        }
        ...
        public interface OnSheetItemClickListener {
            void onClick(MyBottomSheet dialog, View itemView, int position, String tag, Object data);
        }
        ...
        private static class BottomSheetListItemData {
            ...
            public BottomSheetListItemData(String text, String tag,Object data) {
                this.text = text;
                this.tag = tag;
                this.userData = data;
            ...
            public BottomSheetListItemData(String text, String tag, boolean isCenter) {
                this.text = text;
                this.tag = tag;
            ...
            public BottomSheetListItemData(Drawable image, String text, String tag,boolean isCenter) {
                this.image = image;
                this.text = text;
                this.tag = tag;
                this.isCenter = isCenter;
            ...
            public BottomSheetListItemData(Drawable image, String text, String tag, boolean hasRedPoint,boolean isCenter) {
                this.image = image;
                this.text = text;
                this.tag = tag;
            ...
            public BottomSheetListItemData(Drawable image, String text, String tag, boolean hasRedPoint,boolean isCenter, boolean isDisabled) {
                this.image = image;
                this.text = text;
                this.tag = tag;
                this.hasRedPoint = hasRedPoint;
        ...
        private class ListAdapter extends BaseAdapter {
            ...
            public View getView(final int position, View convertView, ViewGroup parent) {
                ...
                if (convertView == null) {
                    ...
                    convertView = inflater.inflate(R.layout.dialog_bottom_select_item, parent, false);
                    holder = new ViewHolder();
                    holder.imageView = convertView.findViewById(R.id.bottom_dialog_list_item_img);
                    holder.fullView = convertView.findViewById(R.id.view_full);
                ...
                if (mNeedRightMark) {
                    ...
                    if (mCheckedIndex == position) {
                        holder.textView.setTextColor(ArmsUtils.getColor(mContext,R.color.base_main_color));
                        holder.markView.setVisibility(View.VISIBLE);
                    } else {
                        holder.textView.setTextColor(ArmsUtils.getColor(mContext,R.color.qmui_s_list_item_text_color));
                ...
                convertView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (mOnSheetItemClickListener != null) {
                            mOnSheetItemClickListener.onClick(mDialog, v, position, data.tag,data.userData);
                        }
                    }
                });
                return convertView;
    ...
    public static class BottomGridSheetBuilder implements View.OnClickListener {
        ...
        public QMUIBottomSheetItemView createItemView(Drawable drawable, CharSequence text, Object tag, int subscriptRes) {
            ...
            TextView titleTV = (TextView) itemView.findViewById(com.qmuiteam.qmui.R.id.grid_item_title);
            ...
            AppCompatImageView imageView = (AppCompatImageView) itemView.findViewById(com.qmuiteam.qmui.R.id.grid_item_image);
            imageView.setImageDrawable(drawable);

            if (subscriptRes != 0) {
                ViewStub stub = (ViewStub) itemView.findViewById(com.qmuiteam.qmui.R.id.grid_item_subscript);
        ...
        private View buildViews() {
            ...
            LinearLayout firstLine = (LinearLayout) baseLinearLayout.findViewById(com.qmuiteam.qmui.R.id.bottom_sheet_first_linear_layout);
            LinearLayout secondLine = (LinearLayout) baseLinearLayout.findViewById(com.qmuiteam.qmui.R.id.bottom_sheet_second_linear_layout);
            mBottomButtonContainer = (ViewGroup) baseLinearLayout.findViewById(com.qmuiteam.qmui.R.id.bottom_sheet_button_container);
            mBottomButton = (TextView) baseLinearLayout.findViewById(com.qmuiteam.qmui.R.id.bottom_sheet_close_button);
            ...
            if (mBottomButtonContainer != null) {
                if (mIsShowButton) {
                    ...
                    int dimen = QMUIResHelper.getAttrDimen(mContext, com.qmuiteam.qmui.R.attr.qmui_bottom_sheet_grid_padding_vertical);
        ...
        protected int getContentViewLayoutId() {
            return com.qmuiteam.qmui.R.layout.qmui_bottom_sheet_grid;
        }

        protected int getItemViewLayoutId() {
            return com.qmuiteam.qmui.R.layout.qmui_bottom_sheet_grid_item;
        }
        ...
        private int calculateItemWidth(int width, int maxItemCountInEachLine, int paddingLeft, int paddingRight) {
            if (mMiniItemWidth == -1) {
                mMiniItemWidth = QMUIResHelper.getAttrDimen(mContext, com.qmuiteam.qmui.R.attr.qmui_bottom_sheet_grid_item_mini_width);
            }
